            ...
            {cats
              ...
              .map((c) => {
                ...
                return (
                  <div
                    key={c.id}
                    className="rounded-2xl bg-[#201c31] border border-[#2a2640] p-3 w-full not-first:mt-4"
                  >
                    <div className="mb-2 flex items-center justify-between break-inside-avoid">
                      <div className="flex items-center gap-2">
                        <span className="h-6 w-1.5 rounded-full bg-linear-to-b from-purple-400 to-fuchsia-400" />
