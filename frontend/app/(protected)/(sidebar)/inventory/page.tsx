...
import InventoryDialogModal from "@/components/InventoryDialogModal";
...
export default function Inventory() {
  ...
  const openModal = async (type: ModalType, product = null) => {
    if (product) {
      setSelectedProduct(product);
    }
    if (type === "ADJUST_STOCK" && product) {
      setFormData((prev) => ({
        ...prev,
    ...
    if (type === "HISTORY" && product) {
      setLoadingHistory(true);
      setActiveModal("HISTORY");
      await fetchTransactionHistory(product.productId);
      setLoadingHistory(false);
      return;
    }
  ...
  return (
    <div className="min-h-screen bg-background p-4">
      <div className="rounded-lg bg-card p-6 shadow-sm border-1 border-[color-mix(in oklab, var(--ring) 50%, transparent)]">
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <Button
              onClick={() => openModal("CREATE_PRODUCT")}
      ...
      <InventoryDialogModal
        isOpen={activeModal === "CREATE_PRODUCT"}
        onClose={() => closeModal()}
      ...
      <InventoryDialogModal
        isOpen={activeModal === "DELETE_PRODUCT"}
        onClose={() => closeModal()}
        contentClassName="sm:max-w-[480px]"
        title="Delete Product"
        description="This action will permanently delete the product and its related data. Are you sure you want to continue?"
      >
        <div className="mt-4">
      ...
      <InventoryDialogModal
        isOpen={activeModal === "CREATE_CATEGORY"}
        onClose={() => closeModal()}
      ...
      <InventoryDialogModal
        ...
        onClose={() => closeModal()}
        title="Add Stock"
        description="Increase the stock quantity for the selected product."
      >
        <div className="mb-4">
      ...
      <InventoryDialogModal
        isOpen={activeModal === "REMOVE_STOCK"}
        onClose={() => closeModal()}
        title="Remove Stock"
        description="Decrease the stock quantity for the selected product."
      >
        <div className="mb-4">
          <p className="text-sm text-gray-600 mb-2">
            Product:{" "}
      ...
      <InventoryDialogModal
        isOpen={activeModal === "ADJUST_STOCK"}
        onClose={() => closeModal()}
        title="Adjust Stock"
        description="Set a new stock quantity for the selected product."
      >
        <div className="mb-4">
          <p className="text-sm text-gray-600 mb-2">
            Product:{" "}
      ...
      <InventoryDialogModal
        ...
        description="View the transaction history for the selected product."
      >
        <div className="mb-4">
          <p className="text-sm text-gray-600">
            Product:{" "}
